...
async function seed() {
  ...
  const portfolioItems = [
    ...
    { title: 'Eclipse Total', style: 'Blackwork', description: 'Sol y luna fusionados en negro sólido con texturas y degradados, pieza de espalda completa.', image_url: 'https://images.unsplash.com/photo-1562379825-415aea84ebcf?w=600&h=800&fit=crop', published: true, sort_order: 1 },
    { title: 'Golondrina Clásica', style: 'Tradicional', description: 'Golondrina old school con rosas y banner, colores saturados y línea gruesa en el pecho.', image_url: 'https://images.unsplash.com/photo-1610942933193-8fafd0973f6d?w=600&h=800&fit=crop', published: true, sort_order: 2 },
    { title: 'Fénix Renacido', style: 'Neo Tradicional', description: 'Fénix con alas desplegadas, paleta de naranjas y dorados, detalles ornamentales modernos.', image_url: 'https://images.unsplash.com/photo-1719068435942-510a83cc6fd7?w=600&h=800&fit=crop', published: true, sort_order: 3 },
    { title: 'Dragón Imperial', style: 'Japonés', description: 'Dragón tradicional japonés con nubes y olas, estilo irezumi en media manga.', image_url: 'https://images.unsplash.com/photo-1601848713660-1863e3dfddc5?w=600&h=800&fit=crop', published: true, sort_order: 4 },
    { title: 'Cubo Imposible', style: 'Geométrico', description: 'Formas geométricas imposibles entrelazadas con líneas de precisión matemática en el antebrazo.', image_url: 'https://images.unsplash.com/photo-1576904394143-8cfeacabde55?w=600&h=800&fit=crop', published: true, sort_order: 5 },
    { title: 'Lobo Cósmico', style: 'Puntillismo', description: 'Retrato de lobo creado enteramente con puntos, degradados suaves y textura única en el hombro.', image_url: 'https://images.unsplash.com/photo-1769605767681-749db570b426?w=600&h=800&fit=crop', published: true, sort_order: 6 },
    ...
    { title: 'Carpe Diem', style: 'Lettering', description: 'Tipografía caligráfica cursiva con ornamentos florales delicados, costado del torso.', image_url: 'https://images.unsplash.com/photo-1537192579892-6e838b38e0e4?w=600&h=800&fit=crop', published: true, sort_order: 10 },
    ...
    { title: 'Constelación Orión', style: 'Minimalista', description: 'Puntos conectados formando la constelación de Orión, trazo ultra fino en la clavícula.', image_url: 'https://images.unsplash.com/photo-1515369867962-4661872b6366?w=600&h=800&fit=crop', published: true, sort_order: 12 },
    { title: 'Corona de Filigrana', style: 'Ornamental', description: 'Diseño ornamental tipo filigrana con detalles barrocos, brazalete completo en el antebrazo.', image_url: 'https://images.unsplash.com/photo-1597227461355-14ff26970fe2?w=600&h=800&fit=crop', published: true, sort_order: 13 },
  ...
  const appointments = [
    ...
    { client_name: 'Carmen Rodríguez', date: '2026-03-12', time: '14:00', description: 'Luna creciente dotwork detrás de la oreja, sutil y delicada', body_part: 'Detrás de la oreja', style: 'Puntillismo', status: 'confirmed', deposit: 60, phone: '+34 634 567 890', email: 'carmen@test.com', reference_images: [], size: 'Pequeño (5-15cm)', notes: '', client_id: clientIds[2]?.uid || null },
    { client_name: 'Sofía López', date: '2026-03-13', time: '10:00', description: 'Mariposa acuarela en la espalda, colores vibrantes con splash effect', body_part: 'Espalda', style: 'Acuarela', status: 'confirmed', deposit: 150, phone: '+34 645 678 901', email: 'sofia@test.com', reference_images: [], size: 'Grande (25cm+)', notes: 'Traer referencias de colores.', client_id: clientIds[3]?.uid || null },
    ...
    { client_name: 'Lucía Martínez', date: '2026-03-16', time: '11:00', description: 'Retoque de serpiente fine line + nueva pieza: flor de cerezo en la muñeca', body_part: 'Muñeca', style: 'Línea Fina', status: 'confirmed', deposit: 60, phone: '+34 612 345 678', email: 'lucia@test.com', reference_images: [], size: 'Pequeño (5-15cm)', notes: 'Retoque gratuito + nueva pieza.', client_id: clientIds[0]?.uid || null },
    { client_name: 'Andrés Pérez', date: '2026-03-18', time: '10:00', description: 'Extensión del mandala hacia el brazo, segunda sesión', body_part: 'Brazo', style: 'Geométrico', status: 'pending', deposit: 150, phone: '+34 623 456 789', email: 'andres@test.com', reference_images: [], size: 'Grande (25cm+)', notes: 'Continuación del trabajo anterior.', client_id: clientIds[1]?.uid || null },
    { client_name: 'Ana Torres', date: '2026-03-20', time: '15:00', description: 'Constelación de estrellas en la clavícula, fine line minimalista', body_part: 'Clavícula', style: 'Línea Fina', status: 'pending', deposit: 70, phone: '+34 667 890 123', email: 'ana@email.com', reference_images: [], size: 'Mediano (15-25cm)', notes: 'Nueva clienta. Referida por Lucía.', client_id: null },
    { client_name: 'Carmen Rodríguez', date: '2026-02-20', time: '10:00', description: 'Rosa geométrica en el tobillo, primer tatuaje', body_part: 'Tobillo', style: 'Geométrico', status: 'completed', deposit: 90, phone: '+34 634 567 890', email: 'carmen@test.com', reference_images: [], size: 'Pequeño (5-15cm)', notes: 'Muy nerviosa pero salió perfecto.', client_id: clientIds[2]?.uid || null },
    { client_name: 'Diego Ruiz', date: '2026-03-22', time: '12:00', description: 'Fénix neo-traditional en el antebrazo, colores vivos', body_part: 'Antebrazo', style: 'Neo Tradicional', status: 'pending', deposit: 180, phone: '+34 678 901 234', email: 'diego@email.com', reference_images: [], size: 'Grande (25cm+)', notes: 'Quiere estilo americano clásico con toques modernos.', client_id: null },
  ]
  ...
  const chatConversations = [
    ...
    },
    {
      ...
      messages: [
        { sender_role: 'client', text: 'Hola! Vi tu portafolio y me enamoré del estilo acuarela. ¿Aceptas nuevos clientes?' },
  ...
  const contacts = [
    ...
    { name: 'Elena Vidal', email: 'elena@email.com', phone: '', message: '¿Cuánto costaría un tatuaje pequeño de una estrella en la muñeca? Es mi primer tatuaje.', tattoo_style: 'Línea Fina', body_part: 'Muñeca' },
  ]
